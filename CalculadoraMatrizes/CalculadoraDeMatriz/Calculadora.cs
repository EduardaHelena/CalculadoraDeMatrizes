    ...
    public partial class Calculadora : Form
    {
       ...
       //método para limpar o campo da matriz resultante
        ...
        private void simetriax_Click(object sender, EventArgs e)
        {
            ...
            matrizResultante = Calculos.MultiplicandoMatrizes(PlanoCartesiano.SimetriaX, matrizGeo); // Multiplica pela simetrica x
            PlanoCartesiano.DrawInChart(grafico, matrizResultante, "Matriz"); // Desenha na Chart
            ...
            for (int x = 0; x < matrizResultante.GetLength(0); x++)
            {
                for (int y = 0; y < matrizResultante.GetLength(1); y++)
                {
                    ...
                    matrizResultante[x, y].Text = matrizGeo[x, y].ToString();
        ...
        private void simetriay_Click(object sender, EventArgs e)
        {
            ...
            matrizResultante = Calculos.MultiplicandoMatrizes(PlanoCartesiano.SimetriaY, matrizGeo); // Multiplica pela simetrica y
            PlanoCartesiano.DrawInChart(grafico, matrizResultante, "Matriz"); // Desenha na Chart
        ...
        private void Rotatebt_Click(object sender, EventArgs e)
        {
            ...
            matrizResultante = Calculos.MultiplicandoMatrizes(PlanoCartesiano.Rotaçao(float.Parse(rotacionarbox.Text)), matrizGeo);
            PlanoCartesiano.DrawInChart(grafico, matrizResultante, "Matriz");
        ...
        private void translacaox_Click(object sender, EventArgs e)
        {
            ...
            matrizResultante = Calculos.SomandoMatrizes(matrizGeo, float.Parse(transalaçaoxbox.Text), 0);
            PlanoCartesiano.DrawInChart(grafico, matrizResultante, "Matriz");
        ...
        private void translacaoy_Click(object sender, EventArgs e)
        {
            ...
            matrizResultante = Calculos.SomandoMatrizes(matrizGeo, float.Parse(transalaçaoybox.Text), 0);
            PlanoCartesiano.DrawInChart(grafico, matrizResultante, "Matriz");
        ...
        private void escalar_Click(object sender, EventArgs e)
        {
            ...
            matrizResultante = Calculos.MultiplicandoMatrizes(PlanoCartesiano.Escalar(float.Parse(escalarbox.Text)), matrizGeo);
            PlanoCartesiano.DrawInChart(grafico, matrizResultante, "Matriz");
